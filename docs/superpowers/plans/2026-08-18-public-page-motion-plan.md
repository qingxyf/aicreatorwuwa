...
- [x] **Step 1: Write the fallback-visible test**
...
- [x] **Step 3: Implement `useScrollReveal`**
...
- [x] **Step 4: Mark existing public sections and cards**
...
- [x] **Step 6: Commit the orchestration change**
...
- [x] **Step 1: Add reveal and stagger styles**
...
- [x] **Step 2: Add interaction feedback styles**
...
- [x] **Step 6: Review and commit styles**
